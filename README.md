...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/urdfpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14776&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/urdfpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `urdfpy` can be installed with:

```
conda install urdfpy
```

It is possible to list all of the versions of `urdfpy` available on your platform with:
